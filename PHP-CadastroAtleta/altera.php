...
$result_usuario="SELECT a.atleta_id,a.nome,a.idade,e.nome as esportenome FROM atleta as a inner join esporte as e on a.esporte_id = e.esporte_id where atleta_id = ?";

$prepStmt = $connect->prepare($result_usuario);
    ...
    <div class="card">
        <div class="card-body">
            <?php
                include_once("conect.php");
            ?>
            <form action="salvaaltera.php" method="POST">
